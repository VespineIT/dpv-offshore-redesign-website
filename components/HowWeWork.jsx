...
const HowWeWork = () => {
  return (
    // Added dark:bg-[#0f172a] for a deep blue-black background
    <section className="py-12 md:py-20 bg-white dark:bg-[#0f172a] overflow-hidden transition-colors duration-300">
      <div className="container mx-auto px-4">
        ...
        <div className="hidden xl:block relative max-w-[1400px] mx-auto h-[600px]">
          ...
          <div className="absolute left-[6%] top-[5%] w-[300px] text-right">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-[13px] mt-4 leading-relaxed pl-8 transition-colors duration-300">
              Our team is ready to assist you anytime. Simply share your requirement with us. Vessel details, location, and the type of service you need. Once we receive your inquiry, we carefully review the information and connect with you to understand the situation clearly.
            </p>
          </div>
          ...
          <div className="absolute left-[52%] -translate-x-1/2 top-[22%] flex flex-col items-center text-center">
            ...
            {/* Description */}
            <p className="text-gray-600 dark:text-gray-400 text-[13px] mt-1 leading-relaxed max-w-[320px] transition-colors duration-300">
              After your request, our experienced engineers carry out a detailed inspection — either on-site or remotely, depending on the project. During this stage, we assess the condition, identify potential issues, and plan the safest and most effective solution.
            </p>
          </div>
          ...
          <div className="absolute right-[12%] top-[-10%] w-[300px]">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-[13px] mt-4 leading-relaxed pr-8 transition-colors duration-300">
              Based on the inspection findings, we prepare a transparent quotation. The proposal clearly explains the scope of work, estimated time, materials, and costs — so you know exactly what to expect before we begin.
            </p>
          </div>
          ...
          <div className="absolute right-[-5%] bottom-[27%] w-[280px] text-left">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-[13px] mt-3 leading-relaxed transition-colors duration-300">
              Once approved, our certified marine technicians begin the job using professional tools, safety standards, and proven procedures. We focus on quality, efficiency, and minimizing downtime, ensuring every task is completed to industry standards.
            </p>
          </div>
        </div>

        {/* Tablet Layout (Icons Removed) */}
        <div className="hidden lg:block xl:hidden relative max-w-4xl mx-auto">
          <div className="grid grid-cols-2 gap-8">
            <div className="flex items-start gap-4">
              ...
              <div className="pt-4">
                <h3 className="text-xl font-bold text-gray-700 dark:text-gray-100 transition-colors duration-300">Send Inquiry</h3>
              </div>
            </div>

            <div className="flex items-start gap-4">
              <div className="relative flex-shrink-0">
                <span className="text-8xl font-bold text-[#251A66] dark:text-[#E0E7FF] leading-none select-none transition-colors duration-300">2</span>
              </div>
              <div className="pt-4">
                <h3 className="text-xl font-bold text-gray-700 dark:text-gray-100 italic transition-colors duration-300">Site inspection</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm mt-2 leading-relaxed transition-colors duration-300">
            ...
            <div className="flex items-start gap-4">
              <div className="relative flex-shrink-0">
                <span className="text-8xl font-bold text-[#251A66] dark:text-[#E0E7FF] leading-none select-none transition-colors duration-300">3</span>
              </div>
              <div className="pt-4">
                <h3 className="text-xl font-bold text-gray-700 dark:text-gray-100 transition-colors duration-300">Proposal & Quotation</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm mt-2 leading-relaxed transition-colors duration-300">
            ...
            <div className="flex items-start gap-4">
              <div className="relative flex-shrink-0">
                <span className="text-8xl font-bold text-[#251A66] dark:text-[#E0E7FF] leading-none select-none transition-colors duration-300">4</span>
              </div>
              <div className="pt-4">
                <h3 className="text-xl font-bold text-gray-700 dark:text-gray-100 transition-colors duration-300">Project execution</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm mt-2 leading-relaxed transition-colors duration-300">
            ...
            <div className="flex items-start gap-4 col-span-2 justify-center">
              <div className="relative flex-shrink-0">
                <span className="text-8xl font-bold text-[#251A66] dark:text-[#E0E7FF] leading-none select-none transition-colors duration-300">5</span>
              </div>
              <div className="pt-4 max-w-md">
                <h3 className="text-xl font-bold text-gray-700 dark:text-gray-100 transition-colors duration-300">Testing & handover</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm mt-2 leading-relaxed transition-colors duration-300">
        ...
        <div className="lg:hidden space-y-8">
          {[
              { id: 1, title: "Send Inquiry", desc: "" },
              { id: 2, title: "Site inspection", desc: "Our team is ready to assist you anytime. Simply share your requirement with us." },
              { id: 3, title: "Proposal & Quotation", desc: "After your request, our experienced engineers carry out a detailed inspection." },
              { id: 4, title: "Project execution", desc: "Based on the inspection findings, we prepare a transparent quotation." },
              { id: 5, title: "Testing & handover", desc: "Once approved, our certified marina technicians begin the job." }
          ].map((item) => (
