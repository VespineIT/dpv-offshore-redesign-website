        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
            ...
            <div className="lg:col-span-6 flex flex-col">
               ...
               {/* Titles */}
               <div className="mb-8">
                 <h2 className="text-[#FF5722] text-[3.8vw] sm:text-2xl lg:text-3xl font-bold tracking-tight leading-snug mb-2 whitespace-nowrap">
                   DPV Offshore & Marine Services L.L.C
                 </h2>
                 <h3 className="text-[#FF5722] text-[3.8vw] sm:text-2xl lg:text-3xl font-bold tracking-tight leading-snug whitespace-nowrap">
