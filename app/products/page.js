    ...
    <main className="min-h-screen bg-gray-50 dark:bg-[#030712] pb-24 font-['Poppins'] transition-colors duration-300 overflow-hidden">
      ...
      <section className="relative w-full h-[50vh] min-h-[400px] md:h-[500px] flex items-center justify-center rounded-b-[40px] md:rounded-b-[60px] shadow-2xl overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image 
            src="/dpv-offshore-redesign-website/images/production-hero.jpg"
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto -mt-10">
          ...
          >
            Bringing maritime visions to reality through precision-engineered eco-vessels and customized manufacturing solutions.
          </motion.p>
        </div>
      </section>
          ...
          return (
            ...
            >
              <motion.div variants={isReversed ? slideInRight : slideInLeft} className="w-full md:w-1/2 relative h-[300px] md:h-[450px] rounded-[24px] overflow-hidden bg-blue-50/50 dark:bg-gray-800/50 shadow-inner group">
                <Image src={item.image} alt={item.title} fill className="object-cover object-center group-hover:scale-105 transition-transform duration-700 ease-in-out" />
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 dark:bg-black/20 transition-colors duration-300"></div>
              </motion.div>

              <motion.div variants={isReversed ? slideInLeft : slideInRight} className="w-full md:w-1/2 flex flex-col justify-center">
